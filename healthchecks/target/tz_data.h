// Timezone data ported verbatim from source/hc/lib/tz.py (healthchecks Django app).
#pragma once
#include <string>
#include <unordered_set>
#include <unordered_map>

static const std::unordered_set<std::string> ALL_TIMEZONES = {
    ...
    "America/Ciudad_Juarez","America/Coral_Harbour","America/Costa_Rica","America/Creston",
    ...
    "America/Rio_Branco","America/Santa_Isabel","America/Santarem","America/Santiago",
    ...
    "Asia/Barnaul","Asia/Beirut","Asia/Bishkek","Asia/Brunei","Asia/Chita","Asia/Chongqing",
    ...
    "Asia/Tel_Aviv","Asia/Thimphu","Asia/Tokyo","Asia/Tomsk","Asia/Ulaanbaatar",
    ...
    "Australia/Sydney","Australia/Yancowinna",
    ...
    "Etc/GMT-9","Etc/GMT0","Etc/Greenwich","Etc/UCT","Etc/Universal","Etc/UTC","Etc/Zulu",
    ...
    "Europe/Tallinn","Europe/Tirane","Europe/Tiraspol","Europe/Ulyanovsk","Europe/Vaduz",
...
static const std::unordered_map<std::string, std::string> LEGACY_TIMEZONES = {
